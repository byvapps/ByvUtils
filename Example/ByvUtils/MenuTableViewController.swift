...
class MenuTableViewController: UITableViewController, ByvMenu {
    ...
    let _transition:ByvTransition = LeftMenuTransition()
    ...
    @IBAction func showAlert(_ sender: Any) {
        let ac = UIAlertController.alertWith(title: "Prueba", message: "Funciona perfectamente", closeButtonTitle: "Cerrar")
        ac.show()
    }
